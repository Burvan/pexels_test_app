...
class MainPageBloc extends Bloc<MainPageEvent, MainPageState> {
  ...
  MainPageBloc({required GetTrendingPhotosUseCase getTrendingPhotosUseCase})
      : _getTrendingPhotosUseCase = getTrendingPhotosUseCase,
        super(const MainPageState.empty()) {
    on<InitEvent>(_onInit);
    on<GetTrendingPhotosNextPageEvent>(_getTrendingPhotos);
  ...
  Future<void> _getTrendingPhotos(
